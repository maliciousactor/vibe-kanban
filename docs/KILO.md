...
* Command: kilocode
  * Description: Start interactive
  * Example: 
* Command: /mode
  * Description: Switch between modes (architect, code, debug, ask, orchestrator)
  * Example: /mode orchestrator
* Command: /model
  * Description: Learn about available models and switch between them
  * Example: 
* Command: /model list
  * Description: List available models
  * Example: 
* Command: /model info
  * Description: Prints description for a specific model by name
  * Example: /model info z-ai/glm-4.5v
* Command: /model select
  * Description: Select and switch to a new model
  * Example: 
* Command: /checkpoint list
  * Description: List all available checkpoints
  * Example: 
* Command: /checkpoint restore
  * Description: Revert to a specific checkpoint (destructive action)
  * Example: /checkpoint restore 41db173a
* Command: /tasks
  * Description: View task history
  * Example: 
* Command: /tasks search
  * Description: Search tasks by query
  * Example: /tasks search bug fix
* Command: /tasks select
  * Description: Switch to a specific task
  * Example: /tasks select abc123
* Command: /tasks page
  * Description: Go to a specific page
  * Example: /tasks page 2
* Command: /tasks next
  * Description: Go to next page of task history
  * Example: 
* Command: /tasks prev
  * Description: Go to previous page of task history
  * Example: 
* Command: /tasks sort
  * Description: Change sort order
  * Example: /tasks sort most-expensive
* Command: /tasks filter
  * Description: Filter tasks
  * Example: /tasks filter favorites
* Command: /teams
  * Description: List all organizations you can switch into
  * Example: 
* Command: /teams select
  * Description: Switch to a different organization
  * Example: 
* Command: /config
  * Description: Open configuration editor (same as kilocode config)
  * Example: 
* Command: /new
  * Description: Start a new task with the agent with a clean slate
  * Example: 
* Command: /help
...
to complete configuration with an interactive workflow on the command line. You can also use the `/config` slash command during an interactive session, which is equivalent to running `kilocode config`.
